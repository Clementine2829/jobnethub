            ...
            <div className={`${job.mainContainer}`}>
                <div className={`${job.container}`}>
                    <a href="#">
                        ...
                        <p className={`${job.textOnImage}`}><strong>Johannesburg</strong></p>
                    </a>
                </div>
                <div className={`${job.container}`}>
                <a href="#">
                        <img src={pretoriaImage} alt="location"/>
                        <p className={`${job.textOnImage}`}><strong>Pretoria</strong></p>
                        </a>
                </div>
                <div className={`${job.container}`}>
                    <a href="#">
                        <img src={rustenburgImage} alt="location"/>
                        <p className={`${job.textOnImage}`}><strong>Rustenburg</strong></p>
                    </a>
                </div>
                <div className={`${job.container}`}>
                    <a href="#">
                        <img src={remoteImage} alt="location"/>
                        <p className={`${job.textOnImage}`}><strong>Remote</strong></p>
                    </a>
                </div>
